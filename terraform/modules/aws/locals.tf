locals {
  ...
  //AWS NETWORK ACL INGRESS
  aws_network_acl_ingress_rule_n = 100
  aws_network_acl_ingress_from_port = 22
  aws_network_acl_ingress_to_port = 22
  ...
  //AWS VPC SG
  aws_vpc_security_group_ingress_rule_cdir = "0.0.0.0/0"
  aws_vpc_security_group_ingress_rule_from_port = 22
  aws_vpc_security_group_ingress_rule_to_port = 22
